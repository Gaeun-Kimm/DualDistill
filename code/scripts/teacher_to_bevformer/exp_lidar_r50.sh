...
logdir=outputs/lidar_to_bevformer_r50
mkdir -p ${logdir}

TORCH_DISTRIBUTED_DEBUG=DETAIL python -m torch.distributed.launch --nnodes=1 --nproc_per_node=2 --node_rank=0 --master_addr="localhost" --master_port="12345" \
