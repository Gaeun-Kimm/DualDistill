...
logdir=outputs/centerpoint_to_bevdepth4d_r50/entropy_minimization+as_b32/
...
############
cp ./tools/epoch_based_runner_modified.py /root/miniconda3/envs/distillbev/lib/python3.8/site-packages/mmcv/runner/epoch_based_runner.py
cp ./tools/tensorboard_modified.py /root/miniconda3/envs/distillbev/lib/python3.8/site-packages/mmcv/runner/hooks/logger/tensorboard.py
############
...
model.teacher_ckpt='/root/gekim/distill-bev/ckpt/centerpoint_epoch_20.pth' \
...
model.img_backbone.pretrained='/root/gekim/distill-bev/ckpt/resnet50-19c8e357.pth' \
